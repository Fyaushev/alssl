...
@hydra.main(version_base=None, config_path=".", config_name="config_segmentation")
def run_exp(config: DictConfig) -> None:
    # Load the dataset
    print("start loading dataset")
    ds_utils = importlib.import_module(f'alssl.data.img_segmentation.{config.experiment.dataset}')
