...
class Resnet18Classifier(nn.Module):
    def __init__(self, num_classes=10, blocks_to_retrain=1):
        ...
        self.backbone = timm.create_model('resnet18.a1_in1k', pretrained=True)
        # self.classifier = deepcopy(self.backbone.head) # same as in the orig model
        self.backbone.fc = nn.Identity()

        self.classifier = nn.Linear(in_features=512, out_features=num_classes, bias=True) # same as in the orig model
