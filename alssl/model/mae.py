...
class MAEClassifier(nn.Module):
    def __init__(self, num_classes=10, blocks_to_retrain=0, use_n_blocks=1):
        ...
        self.backbone = ViTMAEModel.from_pretrained("facebook/vit-mae-base", attn_implementation="sdpa")
...
class LightningMAEClassifier(L.LightningModule):
    def __init__(
        self,
        root='',
        learning_rate=0.001,
        ...
        *args
        ...
        super().__init__()
        self.model = MAEClassifier(num_classes=num_classes, blocks_to_retrain=blocks_to_retrain)
